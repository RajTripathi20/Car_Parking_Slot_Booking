...
public class CarOwnerDetailsService implements UserDetailsService {
    ...
    @Override
    public UserDetails loadUserByUsername(String email_id)
            throws UsernameNotFoundException {
        Optional<CarOwner> carOwner = carOwnerRepository.findUserByUsername(email_id);
        carOwner.orElseThrow(()-> new UsernameNotFoundException("Not found:"+email_id));
